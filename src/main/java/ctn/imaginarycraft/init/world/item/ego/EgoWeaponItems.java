...
import ctn.imaginarycraft.common.world.item.ego.weapon.melee.axe.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.melee.fist.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.melee.hammer.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.melee.knife.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.melee.mace.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.melee.spear.*;
...
import ctn.imaginarycraft.common.world.item.ego.weapon.remote.cannon.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.remote.crossbow.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.remote.gun.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.remote.gun.pistol.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.remote.gun.rifle.*;
import ctn.imaginarycraft.common.world.item.ego.weapon.remote.special.*;
