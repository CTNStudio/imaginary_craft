...
public final class ModAnimations {
  ...
  public static AnimationManager.AnimationAccessor<AttackAnimation> GRANT_US_LOVE_STAB_L1;
  public static AnimationManager.AnimationAccessor<AttackAnimation> GRANT_US_LOVE_STAB_L2;
  public static AnimationManager.AnimationAccessor<AttackAnimation> GRANT_US_LOVE_STAB_L3;
  public static AnimationManager.AnimationAccessor<AttackAnimation> GRANT_US_LOVE_STAB_R1;
  public static AnimationManager.AnimationAccessor<AttackAnimation> GRANT_US_LOVE_STAB_R2;
  public static AnimationManager.AnimationAccessor<AttackAnimation> GRANT_US_LOVE_STAB_R3;
  ...
  public static void build(AnimationManager.AnimationBuilder builder) {
    ...
    GRANT_US_LOVE_SLASH = builder.nextAccessor("entity/grant_us_love/slash", (accessor) -> new GrantUsLoveTentacleAttackAnimation(
      0.5F, accessor, ModArmatures.GRANT_US_LOVE, new AttackAnimation.Phase(0.0f, 0.33f, 0.33f, 0.001f, 0.65f, Float.MAX_VALUE, InteractionHand.MAIN_HAND,
    ...
    //region stab
    GRANT_US_LOVE_STAB_L1 = builder.nextAccessor("entity/grant_us_love/stab_l1", (accessor) ->
    ...
    GRANT_US_LOVE_STAB_L2 = builder.nextAccessor("entity/grant_us_love/stab_l2", (accessor) ->
    ...
    GRANT_US_LOVE_STAB_L3 = builder.nextAccessor("entity/grant_us_love/stab_l3", (accessor) ->
    ...
    GRANT_US_LOVE_STAB_R1 = builder.nextAccessor("entity/grant_us_love/stab_r1", (accessor) ->
    ...
    GRANT_US_LOVE_STAB_R2 = builder.nextAccessor("entity/grant_us_love/stab_r2", (accessor) ->
    ...
    GRANT_US_LOVE_STAB_R3 = builder.nextAccessor("entity/grant_us_love/stab_r3", (accessor) ->
    ...
    GRANT_US_LOVE_SWING_L1 = builder.nextAccessor("entity/grant_us_love/swing_l1", (accessor) -> new GrantUsLoveTentacleAttackAnimation(
      0.2F, accessor, ModArmatures.GRANT_US_LOVE, new AttackAnimation.Phase(0.0f, 0.467f, 0.467f, 0.7f, 1.2f, Float.MAX_VALUE, InteractionHand.MAIN_HAND,
