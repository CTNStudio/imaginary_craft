...
public final class EgoSpecialWeaponItems {
  ...
  public static final DeferredItem<GeoEgoWeaponItem> IN_THE_NAME_OF_LOVE_AND_HATE = register(
    ...
    LcLevelType.WAW, TemplateType.REMOTE,
    new GeoEgoWeaponItem.Builder()
      .remote()
      .damage(5, 6.5f)
      .attackSpeed(minuteToSpeedConversion(1.5f), minuteToSpeedConversion(0.83f))
  ...
  public static final DeferredItem<GeoEgoWeaponItem> SYRINX = register(
    "syrinx_weapon", "泣婴",
    LcLevelType.HE, TemplateType.REMOTE,
    new GeoEgoWeaponItem.Builder()
      .remote()
      .damage(4, 3)
      .attackSpeed(minuteToSpeedConversion(1.5f), minuteToSpeedConversion(0.5f))
  ...
  public static final DeferredItem<GeoEgoWeaponItem> MIMICRY = register(
    "mimicry_weapon", "拟态",
    LcLevelType.ALEPH, TemplateType.MELEE,
    new GeoEgoWeaponItem.Builder()
      .damage(12)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> GRINDER_MK4 = register(
    ...
    LcLevelType.HE, TemplateType.MELEE,
    new GeoEgoWeaponItem.Builder()
      .damage(0)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> PARADISE_LOST = register(
    ...
    LcLevelType.ALEPH, TemplateType.REMOTE,
    new GeoEgoWeaponItem.Builder()
      .remote()
      .damage(6, 24)
      .attackSpeed(minuteToSpeedConversion(1.5f), minuteToSpeedConversion(2))
      .attackDistance(0, 80 - 3)
      .invincibleTick(20)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> OUR_GALAXY = register(
    "our_galaxy", "小小银河",
    LcLevelType.HE, TemplateType.MELEE,// TODO 特殊 棁
    new GeoEgoWeaponItem.Builder()
      .damage(11)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> CRIMSON_SCAR = register(
    ...
    LcLevelType.WAW, TemplateType.MELEE, // 有远程攻击手段但主要近战
    new GeoEgoWeaponItem.Builder()
      .damage(12)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> COBALT_SCAR = register(
    ...
    LcLevelType.WAW, TemplateType.MELEE,
    new GeoEgoWeaponItem.Builder()
      .damage(15)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> MAGIC_BULLET = register(
    ...
    new GeoEgoWeaponItem.Builder()
      .remote()
      .damage(5, 21)
      .attackSpeed(minuteToSpeedConversion(1.5f), minuteToSpeedConversion(2.33f))
  ...
  public static final DeferredItem<GeoEgoWeaponItem> GAZE = register(
    "gaze_weapon", "凝视",
    LcLevelType.HE, TemplateType.SPECIAL,
    new GeoEgoWeaponItem.Builder()
      .damage(3)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> SOUND_OF_A_STAR = register(
    ...
    new GeoEgoWeaponItem.Builder()
      .damage(6, 9)
      .attackSpeed(minuteToSpeedConversion(1.5f), minuteToSpeedConversion(1.67f))
  ...
  public static final DeferredItem<GeoEgoWeaponItem> ENGULFING_DREAM = register(
    ...
    LcLevelType.TETH, TemplateType.SPECIAL,
    new GeoEgoWeaponItem.Builder()
      .damage(0)
      .attackSpeed(minuteToSpeedConversion(0))
      .attackDistance(-3)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> FEATHER_OF_HONOR = register(
    ...
    LcLevelType.WAW, TemplateType.SPECIAL,
    new GeoEgoWeaponItem.Builder()
      .damage(0)
      .attackSpeed(minuteToSpeedConversion(0))
      .attackDistance(-3)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> PINK = register(
    "pink_weapon", "粉红军备",
    LcLevelType.ALEPH, TemplateType.SPECIAL,
    new GeoEgoWeaponItem.Builder()
      .damage(0)
      .attackSpeed(minuteToSpeedConversion(0))
      .attackDistance(-3)
  ...
  public static final DeferredItem<GeoEgoWeaponItem> AMITA = register(
    ...
    new GeoEgoWeaponItem.Builder()
      ...
      .meleeLcDamageType(LcDamageType.PHYSICS)
      .virtueUsageReq(
      .fortitude(VirtueRating.I, false)
      .prudence(VirtueRating.I, false)
      .temperance(VirtueRating.I, false)
      .justice(VirtueRating.I, false)
      .composite(VirtueRating.I, false))
  ...
  public enum TemplateType {
    ...
    TemplateType(final String name, final Set<DeferredItem<? extends Item>> set) {
      this.name = name;
      this.set = set;
    }
