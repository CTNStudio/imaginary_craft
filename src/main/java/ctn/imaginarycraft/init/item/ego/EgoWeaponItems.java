...
public final class EgoWeaponItems extends EgoWeaponRegisterUtil {
  ...
  //region ZAYIN
  public static final DeferredItem<?> SODA = createRemoteWeapon()
    .id("soda_weapon")
    .zhName("美味苏打")
  ...
  public static final DeferredItem<?> PENITENCE = createMeleeWeapon()
    .id("penitence_weapon")
    .zhName("忏悔")
    .lcLevelType(LcLevelType.ZAYIN)
  ...
  public static final DeferredItem<?> WINGBEAT = createMeleeWeapon()
    .id("wingbeat_weapon")
    .zhName("翅振")
    .lcLevelType(LcLevelType.ZAYIN)
    .type(MeleeTemplateType.MACE)
  ...
  //region TETH
  public static final DeferredItem<?> FOURTH_MATCH_FLAME = createRemoteWeapon()
  ...
  public static final DeferredItem<?> SOLITUDE = createRemoteWeapon()
    .id("solitude_weapon")
    .zhName("孤独")
    .lcLevelType(LcLevelType.TETH)
    .type(RemoteTemplateType.PISTOL)
  ...
  public static final DeferredItem<?> BEAK = createRemoteWeapon()
    .id("beak_weapon")
    .zhName("小喙")
    .lcLevelType(LcLevelType.TETH)
    .type(RemoteTemplateType.PISTOL)
  ...
  public static final DeferredItem<?> TODAY_IS_EXPRESSION = createRemoteWeapon()
  ...
  // 这是什么阴的没边的效果（
  public static final DeferredItem<?> TOUGH = createRemoteWeapon()
    .id("tough_weapon")
    .zhName("谢顶之灾")
    .lcLevelType(LcLevelType.TETH)
    .type(RemoteTemplateType.PISTOL)
  ...
  public static final DeferredItem<EngulfingDreamWeaponItem> ENGULFING_DREAM = createRemoteWeapon()
  ...
  // TODO 这把武器一次攻击动画会造成三次伤害。
  public static final DeferredItem<CherryBlossomsWeaponItem> CHERRY_BLOSSOMS = createRemoteWeapon()
  ...
  public static final DeferredItem<?> RED_EYES = createMeleeWeapon()
    .id("red_eyes_weapon")
    .zhName("赤瞳")
    .lcLevelType(LcLevelType.TETH)
    .type(MeleeTemplateType.MACE)
  ...
  public static final DeferredItem<?> RED_EYES_TACHI = createMeleeWeapon()
    ...
    .weaponBuilder(b -> b
      .damage(8)
      .attackSpeed(minuteToSpeedConversion(1.6f))
      .meleeLcDamageType(LcDamageType.PHYSICS)
      .virtueUsageReq(null, null, null, null, null))
    .modelPath("weapon/red_eyes_tachi")
    .buildAndRegister();

  public static final DeferredItem<?> HORN = createMeleeWeapon()
    .id("horn_weapon")
    .zhName("犄角")
    .lcLevelType(LcLevelType.TETH)
  ...
  public static final DeferredItem<?> WRIST_CUTTER = createMeleeWeapon()
  ...
  public static final DeferredItem<?> REGRET = createMeleeWeapon()
    .id("regret_weapon")
    .zhName("悔恨")
    .lcLevelType(LcLevelType.TETH)
  ...
  public static final DeferredItem<?> FRAGMENTS_FROM_SOMEWHERE = createMeleeWeapon()
  ...
  public static final DeferredItem<?> LANTERN = createMeleeWeapon()
    .id("lantern_weapon")
    .zhName("诱捕幻灯")
    .lcLevelType(LcLevelType.TETH)
    .type(MeleeTemplateType.HAMMER)
  ...
  public static final DeferredItem<?> SO_CUTE = createMeleeWeapon()
    .id("so_cute_weapon")
    .zhName("超特么可爱！！！")
    .lcLevelType(LcLevelType.TETH)
  ...
  public static final DeferredItem<?> STANDARD_TRAINING_EGO = createMeleeWeapon()
  ...
  //region HE
  public static final DeferredItem<?> SCREAMING_WEDGE = createRemoteWeapon()
  ...
  public static final DeferredItem<?> HARMONY = createRemoteWeapon()
    .id("harmony_weapon")
    .zhName("谐奏放射器")
    .lcLevelType(LcLevelType.HE)
    .type(RemoteTemplateType.CANNON)
  ...
  public static final DeferredItem<?> LAETITIA = createRemoteWeapon()
    .id("laetitia_weapon")
    .zhName("蕾蒂希娅")
    .lcLevelType(LcLevelType.HE)
  ...
  public static final DeferredItem<SyrinxWeaponItem> SYRINX = createRemoteWeapon()
    .id("syrinx_weapon")
    .zhName("泣婴")
    .lcLevelType(LcLevelType.HE)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<GrinderMk4WeaponItem> GRINDER_MK4 = createMeleeWeapon()
  ...
  public static final DeferredItem<OurGalaxyWeaponItem> OUR_GALAXY = createMeleeWeapon()
  ...
  public static final DeferredItem<LifeForADaredevilWeaponItem> LIFE_FOR_A_DAREDEVIL = createMeleeWeapon()
  ...
  public static final DeferredItem<GazeWeaponItem> GAZE = createMeleeWeapon()
    .id("gaze_weapon")
    .zhName("凝视")
    .lcLevelType(LcLevelType.HE)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<PleasureWeaponItem> PLEASURE = createMeleeWeapon()
    .id("pleasure_weapon")
    .zhName("因乐癫狂")
    .lcLevelType(LcLevelType.HE)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<?> BEAR_PAWS = createMeleeWeapon()
    .id("bear_paws_weapon")
    .zhName("熊熊抱")
    .lcLevelType(LcLevelType.HE)
    .type(MeleeTemplateType.FIST)
  ...
  public static final DeferredItem<?> SANGUINE_DESIRE = createMeleeWeapon()
  ...
  public static final DeferredItem<?> LOGGING = createMeleeWeapon()
    .id("logging_weapon")
    .zhName("伐木者")
    .lcLevelType(LcLevelType.HE)
    .type(MeleeTemplateType.HAMMER)
  ...
  public static final DeferredItem<?> FROST_SPLINTER = createMeleeWeapon()
  ...
  public static final DeferredItem<?> CHRISTMAS = createMeleeWeapon()
    .id("christmas_weapon")
    .zhName("悲惨圣诞")
    .lcLevelType(LcLevelType.HE)
    .type(MeleeTemplateType.MACE)
  ...
  public static final DeferredItem<?> HARVEST = createMeleeWeapon()
    .id("harvest_weapon")
    .zhName("猎头长耙")
    .lcLevelType(LcLevelType.HE)
    .type(MeleeTemplateType.SPEAR)
  ...
  //region WAW
  public static final DeferredItem<?> HORNET = createRemoteWeapon()
    .id("hornet_weapon")
    .zhName("黄蜂")
  ...
  public static final DeferredItem<?> FAINT_AROMA = createRemoteWeapon()
  ...
  public static final DeferredItem<?> EXUVIAE = createRemoteWeapon()
    .id("exuviae_weapon")
    .zhName("脱落之皮")
    .lcLevelType(LcLevelType.WAW)
    .type(RemoteTemplateType.CANNON)
  ...
  public static final DeferredItem<?> HYPOCRISY = createRemoteWeapon()
    .id("hypocrisy_weapon")
    .zhName("伪善")
    .lcLevelType(LcLevelType.WAW)
    .type(RemoteTemplateType.CROSSBOW)
  ...
  public static final DeferredItem<InTheNameOfLoveAndHateWeaponItem> IN_THE_NAME_OF_LOVE_AND_HATE = createRemoteWeapon()
  ...
  public static final DeferredItem<CrimsonScarWeaponItem> CRIMSON_SCAR = createMeleeWeapon()
  ...
  public static final DeferredItem<CobaltScarWeaponItem> COBALT_SCAR = createMeleeWeapon()
  ...
  public static final DeferredItem<SolemnLamentWeaponItem> SOLEMN_LAMENT_BLACK = createRemoteWeapon()
  ...
  public static final DeferredItem<SolemnLamentWeaponItem> SOLEMN_LAMENT_WHITE = createRemoteWeapon()
  ...
  public static final DeferredItem<MagicBulletWeaponItem> MAGIC_BULLET = createRemoteWeapon()
  ...
  public static final DeferredItem<BlackSwanWeaponItem> BLACK_SWAN = createMeleeWeapon()
  ...
  public static final DeferredItem<EcstasyWeaponItem> ECSTASY = createMeleeWeapon()
    .id("ecstasy_weapon")
    .zhName("沉醉")
    .lcLevelType(LcLevelType.WAW)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<TheSwordSharpenedWithTearsWeaponItem> THE_SWORD_SHARPENED_WITH_TEARS = createMeleeWeapon()
  ...
  public static final DeferredItem<FeatherOfHonorWeaponItem> FEATHER_OF_HONOR = createRemoteWeapon()
  ...
  public static final DeferredItem<DiscordWeaponItem> DISCORD = createMeleeWeapon()
    .id("discord_weapon")
    .zhName("不和")
    .lcLevelType(LcLevelType.WAW)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<MoonlightWeaponItem> MOONLIGHT = createMeleeWeapon()
    .id("moonlight_weapon")
    .zhName("月光")
    .lcLevelType(LcLevelType.WAW)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<AmitaWeaponItem> AMITA = createMeleeWeapon()
    .id("amita_weapon")
    .zhName("无量")
    .lcLevelType(LcLevelType.WAW)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<?> LAMP = createMeleeWeapon()
    .id("lamp_weapon")
    .zhName("目灯")
    .lcLevelType(LcLevelType.WAW)
    .type(MeleeTemplateType.HAMMER)
  ...
  public static final DeferredItem<?> GREEN_STEM = createMeleeWeapon()
  ...
  public static final DeferredItem<?> SPORE = createMeleeWeapon()
    .id("spore_weapon")
    .zhName("荧光菌孢")
    .lcLevelType(LcLevelType.WAW)
    .type(MeleeTemplateType.SPEAR)
  ...
  public static final DeferredItem<?> HEAVEN = createMeleeWeapon()
    .id("heaven_weapon")
    .zhName("穿刺极乐")
    .lcLevelType(LcLevelType.WAW)
    .type(MeleeTemplateType.SPEAR)
  ...
  public static final DeferredItem<?> DIFFRACTION = createMeleeWeapon()
  ...
  public static final DeferredItem<MimicryWeaponItem> MIMICRY = createMeleeWeapon()
    .id("mimicry_weapon")
    .zhName("拟态")
  ...
  public static final DeferredItem<JustitiaWeaponItem> JUSTITIA = createMeleeWeapon()
    .id("justitia_weapon")
    .zhName("正义裁决者")
    .lcLevelType(LcLevelType.ALEPH)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<ParadiseLostWeaponItem> PARADISE_LOST = createRemoteWeapon()
  ...
  public static final DeferredItem<TwilightWeaponItem> TWILIGHT = createMeleeWeapon()
    .id("twilight_weapon")
    .zhName("薄暝")
    .lcLevelType(LcLevelType.ALEPH)
    .properties(new Item.Properties())
  ...
  // TODO 这把武器每次攻击时会造成3次物理伤害。
  public static final DeferredItem<GoldRushWeaponItem> GOLD_RUSH = createMeleeWeapon()
    .id("gold_rush_weapon")
    .zhName("闪金冲锋")
    .lcLevelType(LcLevelType.ALEPH)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<SmileWeaponItem> SMILE = createMeleeWeapon()
    .id("smile_weapon")
    .zhName("笑靥")
    .lcLevelType(LcLevelType.ALEPH)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<CensoredWeaponItem> CENSORED = createMeleeWeapon()
    .id("censored_weapon")
    .zhName("CENSORED")
    .lcLevelType(LcLevelType.ALEPH)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<SoundOfAStarWeaponItem> SOUND_OF_A_STAR = createRemoteWeapon()
  ...
  public static final DeferredItem<PinkWeaponItem> PINK = createRemoteWeapon()
    .id("pink_weapon")
    .zhName("粉红军备")
    .lcLevelType(LcLevelType.ALEPH)
    .properties(new Item.Properties())
  ...
  public static final DeferredItem<AdorationWeaponItem> ADORATION = createRemoteWeapon()
    .id("adoration_weapon")
    .zhName("爱慕")
    .lcLevelType(LcLevelType.ALEPH)
    .properties(new Item.Properties())
