package ctn.imaginarycraft.datagen.i18;
...
public abstract class DatagenI18 extends LanguageProvider {
  public DatagenI18(PackOutput output, String locale) {
  ...
  protected void addItemList(Map<DeferredItem<? extends Item>, String> map) {
    map.forEach((holder, zhName) -> {
      add(holder.value(), zhName);
    });
  }
