...
public final class DatagenCuriosTest extends CuriosDataProvider {
  ...
  public static final String EGO_CURIOS_EYE_AREA = "ego_curios_eye_area";
  ...
  public static final String EGO_CURIOS_CHEST = "ego_curios_chest";
  ...
  public static final ResourceLocation EGO_CURIOS_EYE_AREA_VALIDATOR = createTagId("ego_curios_eye_area");
  ...
  public static final ResourceLocation EGO_CURIOS_CHEST_VALIDATOR = createTagId("ego_curios_chest");
  ...
  public void generate(HolderLookup.Provider registries, ExistingFileHelper fileHelper) {
    ...
    createSlot(EGO_CURIOS_EYE_AREA, EGO_CURIOS_EYE_AREA_VALIDATOR);
    ...
    createSlot(EGO_CURIOS_CHEST, EGO_CURIOS_CHEST_VALIDATOR);
