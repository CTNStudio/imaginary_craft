...
public class PinkWeaponItem extends GeoRemoteEgoWeaponItem {
  ...
  public PinkWeaponItem(Properties properties, Builder builder, GeoModel<GeoRemoteEgoWeaponItem> model, GeoModel<GeoRemoteEgoWeaponItem> guiModel) {
    super(properties, builder, model, guiModel);
  }

  public PinkWeaponItem(Properties properties, Builder builder, String modPath) {
