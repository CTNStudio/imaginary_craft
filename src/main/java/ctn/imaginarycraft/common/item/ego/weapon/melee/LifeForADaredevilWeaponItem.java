...
public class LifeForADaredevilWeaponItem extends MeleeEgoWeaponGeoItem {
  ...
  public LifeForADaredevilWeaponItem(Properties itemProperties, Builder egoWeaponBuilder, GeoModel<MeleeEgoWeaponGeoItem> geoModel, GeoModel<MeleeEgoWeaponGeoItem> guiModel) {
