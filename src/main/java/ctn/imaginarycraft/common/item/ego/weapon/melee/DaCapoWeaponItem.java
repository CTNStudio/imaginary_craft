...
public class DaCapoWeaponItem extends GeoMeleeEgoWeaponItem {
  ...
  public DaCapoWeaponItem(Properties properties, Builder builder, GeoModel<GeoMeleeEgoWeaponItem> model, GeoModel<GeoMeleeEgoWeaponItem> guiModel) {
    super(properties, builder, model, guiModel);
  }

  public DaCapoWeaponItem(Properties properties, Builder builder, String modPath) {
