...
public class DiscordWeaponItem extends GeoMeleeEgoWeaponItem {
  ...
  public DiscordWeaponItem(Properties properties, Builder builder, GeoModel<GeoMeleeEgoWeaponItem> model, GeoModel<GeoMeleeEgoWeaponItem> guiModel) {
    super(properties, builder, model, guiModel);
  }

  public DiscordWeaponItem(Properties properties, Builder builder, String modPath) {
