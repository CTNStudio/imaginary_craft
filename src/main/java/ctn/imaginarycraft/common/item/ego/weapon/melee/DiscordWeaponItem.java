...
public class DiscordWeaponItem extends MeleeEgoWeaponGeoItem {
  ...
  public DiscordWeaponItem(Properties itemProperties, Builder egoWeaponBuilder, GeoModel<MeleeEgoWeaponGeoItem> geoModel, GeoModel<MeleeEgoWeaponGeoItem> guiModel) {
