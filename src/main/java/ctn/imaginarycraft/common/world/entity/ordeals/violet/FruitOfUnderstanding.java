...
public class FruitOfUnderstanding extends PathfinderMob implements IOrdealsVioletEntity, ISpawnByEgg, GeoEntity, Enemy {
  ...
  class FruitOfUnderstandingMeleeAttackGoal extends MeleeAttackGoal {
    ...
    @Override
    protected boolean canPerformAttack(LivingEntity p_25556_) {
      return this.isTimeToAttack() &&
        FruitOfUnderstanding.this.distanceToSqr(p_25556_) <= NORMAL_ATK_RANGE * NORMAL_ATK_RANGE;
    }
